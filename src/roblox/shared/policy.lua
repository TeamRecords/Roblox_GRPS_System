...
{ name = "Storm Corporal I", minPoints = 700, minTimeDays = 7, level = "MR" },
{ name = "Storm Corporal II", minPoints = 1000, minTimeDays = 10, level = "MR" },
{ name = "Thunder Sergeant I", minPoints = 1400, minTimeDays = 12, level = "MR" },
{ name = "Thunder Sergeant II", minPoints = 1800, minTimeDays = 14, level = "MR" },
{ name = "Arc Lieutenant I", minPoints = 2200, minTimeDays = 16, level = "MR" },
{ name = "Arc Lieutenant II", minPoints = 2700, minTimeDays = 20, level = "MR" },
{ name = "Captain I", minPoints = 3000, minTimeDays = 14, level = "D&I" },
{ name = "Captain II", minPoints = 3200, minTimeDays = 16, level = "D&I" },
{ name = "Tempest Major", minPoints = 3500, minTimeDays = 21, level = "CMD" },
{ name = "Electro Colonel", minPoints = 5000, minTimeDays = 30, level = "CMD" },
{ name = "Brigadier General", minPoints = 7000, minTimeDays = 45, level = "CCM" },
{ name = "Stormmarshal", minPoints = 8000, minTimeDays = 60, level = "CCM" },
},
punishments = {
trial_threshold = 4,
severe_threshold = 7,
...
["Suspended"] = { level = "L&M", canEarn = false },
["Shock Trooper I"] = { level = "LR" },
["Shock Trooper II"] = { level = "LR" },
["Volt Specialist I"] = { level = "LR" },
["Volt Specialist II"] = { level = "MR", canWarn = true },
["Storm Corporal I"] = { level = "MR", canWarn = true },
["Storm Corporal II"] = { level = "MR", canWarn = true },
["Thunder Sergeant I"] = { level = "MR", canWarn = true },
["Thunder Sergeant II"] = { level = "MR", canWarn = true },
["Arc Lieutenant I"] = { level = "MR", canWarn = true },
["Arc Lieutenant II"] = { level = "MR", canWarn = true },
["Captain I"] = { level = "D&I", canWarn = true },
["Captain II"] = { level = "D&I", canWarn = true },
["Ambassador"] = { level = "CMD", canWarn = true },
["Envoy"] = { level = "CMD", canWarn = true },
["Tempest Major"] = { level = "CMD", canWarn = true, canBan = false },
["Electro Colonel"] = { level = "CMD", canWarn = true, canBan = true },
["Brigadier General"] = { level = "CCM", canWarn = true, canBan = true },
["Stormmarshal"] = { level = "CCM", canWarn = true, canBan = true },
["Imperator"] = { level = "LDR", canWarn = true, canBan = true },
},
},
}
