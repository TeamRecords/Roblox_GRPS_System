  ...
  return (
    <article className="space-y-8 text-sm leading-relaxed text-zinc-200">
      <header className="space-y-3">
        ...
        <h2 className="text-3xl font-semibold text-white">Terms of Service</h2>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">1. Eligibility</h3>
        <p>
          The Service is intended for Roblox players who participate in the GRPS experience. You must comply with the
          Roblox Terms of Use, Community Rules, and any applicable platform policies. Users who are banned or suspended
          from Roblox or GRPS may have their leaderboard access revoked.
        </p>
      </section>

      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">2. Account Data</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">3. Fair Play &amp; Enforcement</h3>
        <p>
          Cheating, exploiting, or manipulating game systems to artificially increase leaderboard standing is prohibited.
          We reserve the right to remove entries, reset statistics, or restrict access without notice if suspicious activity
          is detected. Reports can be submitted through the official GRPS support channels.
        </p>
      </section>

      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">4. Service Availability</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">5. Limitation of Liability</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">6. Changes</h3>
        <p>
      ...
      <section className="space-y-3">
        ...
        <p>
          For questions about these Terms, reach out to the GRPS moderation team via our official Discord server or
          through the support email listed in the Roblox experience description.
        </p>
      </section>
    </article>
  )
