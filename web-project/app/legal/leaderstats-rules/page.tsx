  ...
  return (
    <article className="space-y-8 text-sm leading-relaxed text-zinc-200">
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">1. Respect Platform Policies</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">2. Legitimate Gameplay Only</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">3. Data Integrity</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">4. Community Conduct</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">5. Reporting &amp; Appeals</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">6. Updates</h3>
        <p>
      ...
      <section className="space-y-3">
        <h3 className="text-lg font-semibold text-amber-300">Need Assistance?</h3>
        <p>
